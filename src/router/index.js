    ...
    routes: [
        ...
        { path: '/forgot', name: 'forgot', component: Forgot },
        {
            ...
            children: [
                ...
                { path: 'traveldesc/:storyId', name: 'traveldesc', component: TravelDesc},
                // 游记页面路由
                { path: 'travels', name: 'travels', component: Travels },
                { path: 'travels/writetravel', name: 'writetravel', component: WriteTravel },
                // { path: 'travels/traveldesc/:storyId', name: 'traveldesc', component: TravelDesc},
                // 去旅行页面路由
                { path: 'gotravel', name: 'gotravel', component: GoTravel },
                { path: 'gotravel/scenicspotdesc/:scenicspotId', name: 'scenicspotdesc', component: ScenicspotDesc },
                { path: 'gotravel/scenicspot', name: 'scenicspot', component: Scenicspot },
                { path: 'gotravel/scenicspot/scenicspots', name: 'scenicspots', component: Scenicspots },
                { path: 'gotravel/scenicspot/scenicspots/buyticket', name: 'buyticket', component: BuyTicket },
                { path: 'gotravel/dayplay', name: 'dayplay', component: DayPlay },
                // 个人中心页面路由
                { path: 'mine',name: 'mine', component: Mine },
                { path: 'mine/collection/:userId',name: 'collection', component: Collection },
                { path: 'mine/personaldynamic/:userId',name: 'personaldynamic', component: PersonalDynamic },
                { path: 'mine/changedocument/:userId',name: 'changedocument', component: ChangeDocument },
            ]
        },
    ]
});
